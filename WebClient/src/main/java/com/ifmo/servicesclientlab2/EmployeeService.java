 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://serviceslab2maven.ifmo.com/", wsdlLocation = "http://localhost:8080/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://serviceslab2maven.ifmo.com/", "EmployeeService");
    ...
    public EmployeeWebService getEmployeeWebServicePort() {
        return super.getPort(new QName("http://serviceslab2maven.ifmo.com/", "EmployeeWebServicePort"), EmployeeWebService.class);
    }
    ...
    public EmployeeWebService getEmployeeWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceslab2maven.ifmo.com/", "EmployeeWebServicePort"), EmployeeWebService.class, features);
    }
