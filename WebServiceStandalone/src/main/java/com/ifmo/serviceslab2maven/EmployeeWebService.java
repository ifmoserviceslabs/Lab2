...
public class EmployeeWebService {
    ...
    public int createEmployee(@WebParam(name = "name") String name, @WebParam(name = "surname") String surname, @WebParam(name = "age") int age, @WebParam(name = "city") String city, @WebParam(name = "department") int department){
        return dao.createEmployee(name, surname, age, city, department);
    }

    @WebMethod(operationName = "updateEmployee")
    public String updateEmployee(@WebParam(name = "id") int id, @WebParam(name = "name") String name, @WebParam(name = "surname") String surname, @WebParam(name = "age") int age, @WebParam(name = "city") String city, @WebParam(name = "department") int department){
